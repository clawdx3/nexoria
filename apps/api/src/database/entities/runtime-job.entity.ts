...
export type RuntimeJobType = 'openclaw_task' | 'create_file' | 'research' | 'browser_task';
...
export class RuntimeJob {
  ...
  @Column({ type: 'enum', enum: ['openclaw_task', 'create_file', 'research', 'browser_task'], default: 'openclaw_task' })
  type: RuntimeJobType;
